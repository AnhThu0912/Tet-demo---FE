    ...
    <header className="sticky top-0 z-50 bg-[#C62828] text-white shadow-lg border-b-4 border-[#FFD700]">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="flex flex-col cursor-pointer" onClick={() => onNavigate('home')}>
          <h1 className="text-3xl font-bold tracking-tight heading-serif text-[#FFD700]">Chợ Tết Online</h1>
          <p className="text-xs italic font-medium opacity-90 tracking-widest uppercase">Sắm Tết đủ đầy – Vui xuân trọn vẹn</p>
        </div>
